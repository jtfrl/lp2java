...
public class Us{
    ...
    protected Integer idUs;

    //criar atributo de histórico de transferencia

    public Us(String nome, BigDecimal v, String pais, ZoneId itUs, Integer id) {
        this.nome=nome;
    ...
    public void addSaldo(BigDecimal sd){
        if(sd.compareTo(BigDecimal.ZERO)<=0) throw new IllegalArgumentException("Valor inserido inválido.");
        this.valor=sd;
    }
